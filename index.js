...
// ==============================================================
// ==============================================================
// 🎨 YANGILANGAN SVG INFOGRAFIKA (Dinamik rasmlar va Shriftlar bilan)
// ==============================================================
// ==============================================================
...
async function createCollage(photoUrls, adData = {}) {
  ...
  if (buffers.length === 1) {
    ...
    composites.push({ input: img2, top: 80, left: 680 });
    const img3 = await sharp(buffers[2]).resize(300, 250, { fit: "cover" }).toBuffer();
  ...
  const svgOverlay = `
    <svg width="${canvasWidth}" height="${canvasHeight}">
      ...
      <text x="110" y="127" font-size="18" font-family="${fonts}" font-weight="bold" fill="white" text-anchor="middle">🔥 YANGI E'LON</text>
      ...
      <text x="350" y="665" font-size="18" font-family="${fonts}" fill="#666">⏱ PROBEG</text>
      <text x="350" y="695" font-size="26" font-family="${fonts}" font-weight="bold" fill="#222">${probeg}</text>

      <text x="590" y="665" font-size="18" font-family="${fonts}" fill="#666">🖌 KRASKASI</text>
      <text x="590" y="695" font-size="26" font-family="${fonts}" font-weight="bold" fill="#222">${paint}</text>

      <text x="830" y="665" font-size="18" font-family="${fonts}" fill="#666">🎨 RANGI</text>
      <text x="830" y="695" font-size="26" font-family="${fonts}" font-weight="bold" fill="#222">${color}</text>

      <text x="110" y="765" font-size="18" font-family="${fonts}" fill="#666">⚙️ KAROBKA</text>
      <text x="110" y="795" font-size="26" font-family="${fonts}" font-weight="bold" fill="#222">${trans}</text>

      <text x="350" y="765" font-size="18" font-family="${fonts}" fill="#666">⛽ YOQILG'I</text>
      <text x="350" y="795" font-size="26" font-family="${fonts}" font-weight="bold" fill="#222">${fuel}</text>

      <text x="590" y="765" font-size="18" font-family="${fonts}" fill="#666">📍 VILOYAT</text>
      <text x="590" y="795" font-size="26" font-family="${fonts}" font-weight="bold" fill="#222">${region}</text>
      ...
      <text x="40" y="945" font-size="22" font-family="${fonts}" fill="#333">✅ Toza va ozoda holat</text>
      <text x="40" y="985" font-size="22" font-family="${fonts}" fill="#333">✅ Karobkasi: ${trans}</text>
      <text x="40" y="1025" font-size="22" font-family="${fonts}" fill="#333">✅ Yoqilg'i: ${fuel}</text>
      <text x="40" y="1065" font-size="22" font-family="${fonts}" fill="#333">✅ Real rasmlar va ishonchli variant</text>

      <rect x="520" y="850" width="460" height="250" rx="20" fill="#e3f2fd" />
      <rect x="540" y="870" width="40" height="40" rx="10" fill="#2196f3" />
      <text x="600" y="898" font-size="22" font-family="${fonts}" font-weight="bold" fill="#1565c0">NIMA UCHUN USHBU E'LON?</text>
      <text x="540" y="945" font-size="22" font-family="${fonts}" fill="#333">✔️ Qulay narx va sifatli holat</text>
      <text x="540" y="985" font-size="22" font-family="${fonts}" fill="#333">✔️ O'z vaqtida xizmat qilingan</text>
      ...
      <text x="620" y="1170" font-size="24" font-family="${fonts}" font-weight="bold" fill="#1565c0" text-anchor="middle">✈️ #${region.replace(/\s+/g, "_")}</text>
      ...
      <text x="250" y="1375" font-size="22" font-family="${fonts}" font-weight="bold" fill="#1565c0" text-anchor="middle">🚘 ENG ARZON MASHINALAR</text>
      <text x="750" y="1375" font-size="22" font-family="${fonts}" font-weight="bold" fill="#1565c0" text-anchor="middle">✅ SIZNING ISHONCHLI BOZORINGIZ!</text>
    </svg>
  `;
